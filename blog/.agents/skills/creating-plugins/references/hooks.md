...
Public page hooks let plugins contribute to the rendered output of public site pages. Templates opt in to these contributions with `<KafeCMSHead>`, `<KafeCMSBodyStart>`, and `<KafeCMSBodyEnd>` components.
